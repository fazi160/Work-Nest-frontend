...
function SuccessfulPayment() {
  ...
  return (
    <div className="bg-gray-100 h-screen">
      ...
      <svg viewBox="0 0 24 24" className={`w-16 h-16 mx-auto my-6 ${success ? 'text-green-600' : 'text-red-600'}`}>
        ...
        <div className="text-center">
          ...
          {!loading && success && (
            <>
              ...
              <p className="text-gray-600 my-2">Thank you for doing business with us.</p>
